...
<body>
		<div class="wrap">
				...
				<form name="update" action="articledeletebyids.do" method="post" onsubmit="return chkids()">
						<table class="list-style Interlaced">
								...
								<c:forEach items="${ARTICLE}" var="article">
										<tr>
												...
												<td class="center">${article.channel}</td>
				...
				<div class="turnPage center fr">
										...
										<a href="articlelist.do?page=${PAGE==PAGECONT?PAGE:PAGE+1}">下一页</a> 
										<a href="articlelist.do?page=${PAGECONT}">最后一页</a> 第${PAGE}/共${PAGECONT}页,${COUNT}条信息
								</div>
						</div>
				</form>
		</div>
