...
<body>
		<div class="wrap">
				<div class="page-title">
						<span class="modular fl"><i class="message"></i><em>广告列表</em></span>
				...
				<form name="update" action="messagedeletebyids.do" method="post" onsubmit="return chkids()">
						...
						<div style="overflow: hidden;">
							...
							<div class="turnPage center fr">
										...
										<a href="messagelist.do?page=${PAGE==PAGECONT?PAGE:PAGE+1}">下一页</a> 
										<a href="messagelist.do?page=${PAGECONT}">最后一页</a> 第${PAGE}/共${PAGECONT}页,${COUNT}条信息
								</div>
						</div>
				</form>
		</div>
