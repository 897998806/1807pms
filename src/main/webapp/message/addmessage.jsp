		...
		<div class="tpl-portlet-components">
				<div class="portlet-title">
						<div class="caption font-green bold">
								<span class="am-icon-code"></span> 广告新增 <a href="../messagelist.do?page=1"
				...
				<div class="tpl-block ">
						<div class="am-g tpl-amazeui-form">
								<div class="am-u-sm-12 am-u-md-9">
										<form id="myform" name="myform"class="am-form am-form-horizontal" action="../messageadd.do?page=1"	method="post" onsubmit="return chkSubmit()">
												<!-- 标题 -->
												<div class="am-form-group">
													<label for="message-name" class="am-u-sm-3 am-form-label">标题/messageName</label>
													<div class="am-u-sm-9">
													<input type="text" id="title" name="title" onblur="MessageTitle()"placeholder="标题/title" style="float: left;">
												...
												<div class="am-form-group">
													...
													<div class="am-u-sm-9">
														<textarea class="" rows="10" id="content" onblur="MessageContent()" placeholder="请输入文章内容/Content" name="content"></textarea>
												...
												<div class="am-form-group">
														<label for="user-name" class="am-u-sm-3 am-form-label">创建时间/ctime</label>
														<div class="am-u-sm-9">
															<input type="text" id="ctime" onblur="setTimeout('MessageCtime()', '1000')" name="ctime" class="am-form-field tpl-form-no-bg"	placeholder="创建时间" data-am-datepicker="" readonly />
															<small><span id="ctimemsg" ></span></small>
														</div>
												</div>
												<div class="am-form-group">
													<label for="user-email" class="am-u-sm-3 am-form-label">创建人/ cman</label>
														<div class="am-u-sm-9">
															<input type="text" id="cman" onblur="MessageCman()" name="cman"placeholder="创建人 / cman"> 
