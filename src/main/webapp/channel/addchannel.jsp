...
function ChannelCname() {
	var cnameStr=document.getElementById("cname").value;
	var msg= document.getElementById("cnamemsg");
	if(cnameStr!=""){
		if (chkCnameExist(cnameStr)) {
			return true;
		} else {
			return false;
		}
	...
	<div class="tpl-portlet-components">
		<div class="portlet-title">
			<div class="caption font-green bold">
				<span class="am-icon-code"></span> 栏目新增 <a href="channellist.do?page=1"
		...
		<div class="tpl-block ">
			<div class="am-g tpl-amazeui-form">
				<div class="am-u-sm-12 am-u-md-9">
					<form id="myform" name="myform" class="am-form am-form-horizontal"action="channeladd.do" method="post" onsubmit="return chkSubmit() ">
						<!-- 栏目名 -->
					<div class="am-form-group">
						<label for="channel-name" class="am-u-sm-3 am-form-label">栏目名/ChannelName</label>
						<div class="am-u-sm-9">
							<input type="text" id="cname" onblur="ChannelCname()" name="cname"	placeholder="栏目名 /ChannelName" style="float: left;"> 
							<small>栏目名不能空<span id="cnamemsg" ></span></small>
						</div>
					</div>
						
						<!-- 上级栏目 -->
						<div class="am-form-group">
							<label for="pid-name" class="am-u-sm-3 am-form-label">上级栏目/</label>
							<div class="am-u-sm-9">
						...
						<div class="am-form-group">
							...
							<div class="am-u-sm-9">
								<input type="text" id="sort" name="sort" onblur="ChannelSort()" placeholder="" style="float: left;"> <small>
									<span id="sortmsg" ></span></small>
							</div>
						</div>
